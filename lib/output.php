 ...
 *
 * This file adds the required CSS to the front end to the Genesis Royal Navy Golfing Society Theme.
 *
...
add_action( 'wp_enqueue_scripts', 'genesis_rngs_css' );
/**
...
function genesis_rngs_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'genesis_rngs_logo_width', 350 );
