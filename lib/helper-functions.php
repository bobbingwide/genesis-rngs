 ...
 *
 * This file adds the required helper functions used in the Genesis Royal Navy Golfing Society Theme.
 *
 ...
 */
function genesis_rngs_color_contrast( $color ) {
 ...
 */
function genesis_rngs_color_brightness( $color, $change ) {
